...
export default function PremiumPricingPlanCard() {
  return (
    <div className="bg-card relative rounded-3xl border shadow-2xl shadow-zinc-950/5">
      <div className="grid items-center gap-12 divide-y p-12 md:grid-cols-2 flex-wrap-reverse md:divide-x md:divide-y-0">
        <div className="pb-12 text-center md:pb-0 md:pr-12">
          ...
          <p className="text-muted-foreground mt-12 text-sm">
            Includes : Security, Unlimited Storage, Payment, Search engine, and
            all features
          </p>
        </div>
