...
export default function WaitlistSection() {
  return (
    <PageSection className="relative flex items-center justify-center h-full overflow-hidden py-18 lg:pb-20">
      <BackgroundLines className="container flex flex-col items-center justify-center w-full md:h-full">
        ...
        <WaitlistForm className="relative z-20 flex items-start w-full max-w-md gap-3 mt-10" />
      </BackgroundLines>
