  ...
  return (
    <NavigationMenu viewport={false} className="hidden lg:flex">
      <NavigationMenuList>
        ...
        <NavigationMenuItem>
          <TopLevelNavigationMenuLink href="/help/download">
            How to Download?
          </TopLevelNavigationMenuLink>
        </NavigationMenuItem>
      </NavigationMenuList>
...
function TopLevelNavigationMenuLink({ ...props }: NavigationMenuLinkProps) {
  return (
    <NavigationMenuLink
      ...
      className={cn(
        "group inline-flex h-10 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground",

        "before:absolute before:bottom-0 before:left-0 before:right-0 before:h-0.5 before:bg-primary before:scale-x-0 before:transition-transform before:duration-300 hover:before:scale-x-100",
        props.active && "before:scale-x-100 text-primary",

        "focus-within:bg-accent focus-within:text-accent-foreground focus-within:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:!bg-accent/50 data-[state=open]:bg-accent/50 cursor-pointer relative"
      )}
    >
      {props.children}
    </NavigationMenuLink>
